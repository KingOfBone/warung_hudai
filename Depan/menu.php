			...
			<div class="container">
				...
				<div class="contact-form2">
					...
					<div style='text-align:right;'>
						<a href='#modal-tambah' role='button' class='blue' data-toggle='modal'> + Tambah Menu </a>
					</div>
					<div class="contact-info">													
						<div class="row">
							<div class="col-lg-12">
											...
											<table class="table table-striped table-bordered table-hover" id="dataTables-example-0">
												...
												<tbody>
													<?php
														...
														$sql = "select * from menu order by nama_paket asc";
														...
														while($data = mysqli_fetch_assoc($hasil)) {
															echo "
																<tr class='gradeX'>
																	...
																	<td align='center'>".$data['detail_menu']."</td>
																	<td align='center'>".$data['Jenis']."</td>
																	<td align='center'>".$data['lama_buat']."</td>
																	<td align='center'>
																		<a href='#modal-form-$i' role='button' class='blue' data-toggle='modal'> Ubah </a> |
																		<a onclick=\"return confirm('Anda yakin?')\" href='menu_hapus.php?id_menu=$data[id_menu]'>Hapus</a>																		
																	</td>
																</tr>
															";
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="contact-form">
									<form enctype='multipart/form-data' method='post' action='menu_tambah.php'>
										<div class="contact-left">
											Nama Paket : <input type="text" name="nama_paket" >
											Detail Menu : <input type="text" name="detail_menu" >
											Jenis : <input type="text" name="jenis" >
										</div>
										<div style='margin-left:20%;;' class="contact-left">
											Lama Buat : <input type="text" name="lama_buat" >
			...
			<div id="modal-form-<?php echo $i; ?>" class="modal" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h4 class="blue bigger">Ubah Menu</h4>
						</div>
						...
						<div class="modal-body">
							<div class="row">
								...
								<div class="col-xs-12">
									<div class="contact-form">
										<form method='post' action='menu_ubah.php'>
											<div class="contact-left">
												Nama Paket : <input type="text" name="nama_paket" value='<?php echo $data['nama_paket']; ?>' >
												Detail Menu : <input type="text" name="detail_menu" value='<?php echo $data['detail_menu']; ?>' >
											</div>
											<div style='margin-left:20%;;' class="contact-left">
												Jenis : <input type="text" name="jenis" value='<?php echo $data['Jenis']; ?>' >
												Lama Buat : <input type="text" name="lama_buat" value='<?php echo $data['lama_buat']; ?>' >
											</div>
