	...
	<body>
															...
															echo "
																<tr class='gradeX'>
																	...
																	<td align='center'>
																		...
																		<a onclick=\"return confirm('Anda yakin?')\" href='pesanan_adm_hapus.php'>Hapus</a>																		
																	</td>
																</tr>
															";
		...
		<?php 
			...
			$sql = "
				...
				inner join menu
					on pesanan.id_menu=menu.id_menu															
				order by id_pesanan desc limit 10
			";
			$hasil = mysqli_query($konek, $sql);
									...
									<div class="contact-form">
										<form method='post' action='pesanan_adm_ubah.php'>
											...
											<div style='margin-left:20%;;' class="contact-left">
												Pemesan : <input type="text" name="pemesan" value='<?php echo $data['pemesan']; ?>' >
