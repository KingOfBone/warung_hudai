							...
							<?php
								...
								while($data = mysqli_fetch_assoc($hasil)) {
									...
									<tr class='odd gradeX'>
										...
										<td>$jumlah_baris</td>
										<td><a onClick=\"return confirm('Apakah anda yakin ingin menghapus Data Kesehatan yang ke $data[input_ke] ?')\" href='$url_hapus_data_kesehatan_proses?input_ke=$data[input_ke]'><p class='fa fa-edit'> Hapus </p></a></td>
									</tr>
									";
